import os
from baseline.MiFuSR.skrec import merge_config_with_cmd_args
from baseline.MiFuSR.skrec import ModelRegistry
from baseline.MiFuSR.skrec import RunConfig
from baseline.MiFuSR.skrec.utils.hyperopt import HyperOpt
...
def main():
    run_dict = {"recommender": "MiFuSR",
                "data_dir": "dataset/Lastfm2k",
                "file_column": "UIRT",
                "sep": '\t',
                "hyperopt": False,
                "gpu_id": 0,
    ...
    model_params = {"lr": 1e-3, "epochs": 2000}
